...
// --------------------------------------------------------------------------------------------//
  async run(ctx) {
    ...
    const embed = new EmbedBuilder().setThumbnail(`https://media.discordapp.net/attachments/1257260830219702386/1411371946070904832/Screenshot_2025-08-30-11-27-39-081_jp.ne.ibis.ibispaintx.app-edit.jpg`).setTitle(rand(msgs)).setDescription("awesome art by very very cool person").setFooter({ text: `your/total pats: ${uPats}/${pats.pats}`})
